<template>
  <nav class="text-xs text-gray-500 font-light py-2 px-6 bg-gray-100" aria-label="Breadcrumb">
    <ol v-if="crumbs !== null" class="list-none p-0 inline-flex">
      <li class="flex items-center">
        <NuxtLink :to="home" class="hover:text-gray-800">Home</NuxtLink>
      ...
      <li class="flex items-center" v-for="(item, index) in crumbs">
        ...
        <svg v-if="index < crumbs.length-1" class="fill-current w-3 h-3 mx-3 opacity-40"
