<template>
  <div class="relative">
    ...
    <!-- Form -->
    <div class="py-3">
      <h1 class="text-2xl">Set new password</h1>
    </div>
...
<script>
import confirmResetPassword from './apollo/mutations/identity_confirm_reset_password.graphql'
...
export default {
  ...
  methods: {
    ...
    async onSubmit() {
      this.loading = true;
      let pwChange = Object.assign({}, this.pwChange);
      pwChange.token = this.token;
