<template>
  ...
  <div class="relative">
    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
      <h1 class="my-6 text-3xl font-extrabold text-gray-900">Sign in to your account</h1>
      <div class="mb-2">
      ...
      <div class="mb-2">
        ...
        <div class="relative">
          ...
          <div class="absolute inset-y-0 -top-3 right-0 pr-3 flex items-center text-sm leading-5 z-20">
            <svg @click="switchVisibility()" v-if="!showPassword()" class="h-6 w-6 text-app-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div class="text-sm mb-4">
        <NuxtLink to="/identity/password-reset" class="font-medium text-app-700 hover:text-app-800">
      ...
      <div class="flex items-center justify-between">
        ...
        <span class="text-sm text-gray-500">
          You don't have an account yet? <NuxtLink to="/identity/register" class="inline text-app-500 hover:text-app-800"> Register </NuxtLink>
          </span>
      </div>
    </div>
  </div>
